...
def stkname_from_demand(isload,simpword):
    ...
    sql = 'SELECT id,date,demand from capvision_fun.demands where client_type ="MFund" and sug_labels ="" order by id desc'
...
if ctype == 'demand_req':
  ...
  # time /home/capvision/pyut/capv_2_stk.py req_stkname load full
  # time /home/capvision/pyut/capv_2_stk.py req_stkname load simp
  # /home/capvision/pyut/capv_2_stk.py req_stkname data full
